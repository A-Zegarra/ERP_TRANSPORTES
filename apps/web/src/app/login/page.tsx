...
export default function LoginPage() {
  return <div className="page-wrap auth-layout">
    <section className="auth-intro"><div className="eyebrow"><BrandName /></div>
      ...
      <div className="auth-assurance"><ShieldCheck size={21} aria-hidden="true" /><span>Acceso personal para tu equipo.</span></div>
    </section>
